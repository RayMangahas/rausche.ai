      ...
      <div className="flex items-center justify-between mb-3.5">
        <div>
          ...
          <p className="text-xs text-soft-text-secondary mt-0.5 font-medium">
            {users.length} people matched to you
          </p>
        </div>
              ...
              {users.slice(pageIdx * 4, pageIdx * 4 + 4).map((user) => {
                ...
                return (
                  ...
                  >
                    ...
                    <p className="text-[11px] text-soft-muted mb-1 leading-snug font-medium">
                      {user.vibe}
                    </p>
                    ...
                    {isPinged && (
                      <div className="mt-1.5 flex items-center gap-1 text-[11px] font-semibold text-soft-purple">
                        <MicIcon size={12} />
                        <span>Ping sent</span>
                      </div>
                    )}
