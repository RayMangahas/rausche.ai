...
export default function ProfilePage() {
  ...
  const saveProfile = () => {
    setProfile({ name: nameDraft, username: usernameDraft, avatarEmoji: emojiDraft, avatarColor: colorDraft });
  ...
  return (
    <div className="px-5 pt-6 pb-24">
      {/* Profile banner with user color */}
      <div
        className="rounded-softer p-5 mb-5 -mx-1"
        style={{ background: `linear-gradient(135deg, ${profile.avatarColor}20, ${profile.avatarColor}08)` }}
      >
        <div className="flex items-center gap-4 mb-3">
          <div
            className="w-16 h-16 rounded-soft flex items-center justify-center text-3xl shadow-lg"
        ...
        >
          ...
          >
            ...
            <div className="flex justify-center mb-4">
              <div
                className="w-20 h-20 rounded-soft flex items-center justify-center text-4xl shadow-lg"
            ...
            <div className="mb-3">
              <label className="text-[11px] text-soft-text-secondary font-semibold uppercase tracking-wider block mb-1.5">Choose your avatar</label>
                  ...
                  {POPULAR_EMOJIS.map((emoji) => (
                    <button
                      ...
                      className={`w-10 h-10 rounded-lg text-xl flex items-center justify-center transition-all flex-shrink-0 ${
                        emojiDraft === emoji ? "bg-soft-purple scale-110 shadow-md" : "bg-soft-lavender-bg hover:bg-soft-lavender-light"
                      }`}
                    >
                      {emoji}
                    </button>
            ...
            <div className="mb-4">
              ...
              <div className="flex gap-2">
                <input
                  ...
                  className="flex-1 bg-soft-lavender-bg rounded-xl px-3 py-2.5 text-[14px] text-center border border-soft-lavender-border outline-none focus:ring-2 focus:ring-soft-purple/20"
                />
                <button
                  onClick={handleCustomEmoji}
                  className="bg-soft-purple text-white text-[12px] font-semibold px-4 rounded-xl hover:bg-soft-purple-dark transition-colors"
                >
                  Use
                </button>
              </div>
            ...
            {/* Color picker */}
            <div className="mb-4">
              <label className="text-[11px] text-soft-text-secondary font-semibold uppercase tracking-wider block mb-1.5">Avatar color</label>
              <div className="flex flex-wrap gap-2 mb-2.5">
                {PRESET_COLORS.map((color) => (
                  <button
                    ...
                    className={`w-9 h-9 rounded-lg transition-all ${
                      colorDraft === color ? "scale-110 shadow-md ring-2 ring-soft-purple ring-offset-2" : "hover:scale-105"
                    }`}
                ...
                <button
                  ...
                  className="w-9 h-9 rounded-lg transition-all hover:scale-105 flex items-center justify-center text-[10px] font-bold text-soft-purple border-2 border-dashed border-soft-lavender"
                  style={{
                    background: `conic-gradient(from 0deg, #ff0000, #ffff00, #00ff00, #00ffff, #0000ff, #ff00ff, #ff0000)`,
                    WebkitBackgroundClip: "padding-box",
                  }}
                >
                  <span className="bg-white rounded-md px-0.5 text-[8px]">+</span>
                </button>
                <input
                  ref={colorPickerRef}
                  type="color"
              ...
              <div>
                <input
                  ...
                  onChange={(e) => {
                    ...
                    // HSL to hex with saturation 50%, lightness 60%
                    const s = 0.45, l = 0.60;
                  ...
                  style={{
                    background: `linear-gradient(to right, 
                      hsl(0,45%,60%), hsl(30,45%,60%), hsl(60,45%,60%), 
                      hsl(90,45%,60%), hsl(120,45%,60%), hsl(150,45%,60%), 
                      hsl(180,45%,60%), hsl(210,45%,60%), hsl(240,45%,60%), 
                      hsl(270,45%,60%), hsl(300,45%,60%), hsl(330,45%,60%), 
                      hsl(360,45%,60%))`,
                  }}
                />
